...
# load the marginal effects and baysian effects from JZ
#"data/processed/Table_posterior_mutation_effects_RIL+RIAIL.csv"
##"data/processed/Table_posterior_mutation_effects_RIL.csv"
#"data/processed/Table_posterior_mutation_effects_RIAIL.csv"
mar_eff_boots <- data.table::fread("")
